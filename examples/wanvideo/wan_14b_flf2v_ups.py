...
#     local_dir="./",
#     allow_file_pattern=["data/examples/wan/lady.jpeg", "data/examples/wan/lady.jpeg"]
# )
...
video = pipe(
    ...
    input_image=Image.open("data/examples/wan/lady.png").resize((720, 1280)),
    end_image=Image.open("data/examples/wan/lady.png").resize((720, 1280)),
    height=1280, width=720,
    seed=1, tiled=True
)
if dist.get_rank() == 0:
    save_video(video, "mi300_wan14_s4_flf2v_lady.mp4", fps=15, quality=5)
