...
video = pipe(
    ...
    prompt="A high-resolution cinematic video showing four East Asian adults elegantly jumping once in slow motion at an outdoor daytime wedding. The groom, in a dark suit and colorful tie, and the bride, in a graceful white gown holding a bouquet, are joined by two casually dressed guests—one in a floral shirt with loose pants, the other in a light hat, sleeveless blouse, and long white skirt. They jump in unison with joyful expressions, captured in crisp detail as their clothes and hair subtly move with the motion. The scene takes place in front of a white curtain decorated with colorful flowers, surrounded by greenery and dappled sunlight. The moment is clear, elegant, and celebratory, with a soft, uplifting atmosphere.",
