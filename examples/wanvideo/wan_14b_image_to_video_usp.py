...
# )
image = Image.open("data/examples/wan/man1_last_frame.png")
...
video = pipe(
    ...
    promt="The young man continues live-streaming in the same cozy, minimalist living room. He sits upright with a calm and confident posture, gazing steadily and firmly into the camera, conveying determination and focus. His facial expression remains friendly yet assured, with a slight, composed smile. His hands rest naturally on the desk or lightly clasped together, making very minimal gestures—only an occasional small movement to maintain a natural flow. The background features warm ambient lighting, modern furniture, and subtle personal decorations like a bookshelf and a framed artwork, enhancing the cozy yet professional atmosphere.",
