...
video = pipe(
    ...
    prompt="The animated scene continues in the same warm, hand-drawn Ghibli style, showing the distinguished East Asian woman standing tall against a softly textured navy backdrop. Her posture is upright yet relaxed, and her expression has shifted into one of calm determination. Her eyes shine with clarity and quiet strength as she addresses the audience with a powerful call for educational transformation and equal access. Her gestures are minimal and composed—one hand lightly holding a pointer device while the other rests in a natural, ready position—conveying confidence without force. The lighting subtly focuses on her upper body, gently illuminating her face and blazer with warm, painterly tones. As the camera slowly pushes in, her thoughtful gaze occasionally meets the viewer's, creating a moment of connection filled with sincerity and vision. The atmosphere is steady and inspiring, leaving a lasting impression of leadership grounded in empathy and purpose.",
