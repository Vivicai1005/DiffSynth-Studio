...
# )
image = Image.open("data/examples/wan/man1.png")
...
video = pipe(
    ...
    prompt="A young man aged 25 to 35 is sitting comfortably in a cozy, minimalist living room filled with soft natural light. He is wearing a light sweater and casual pants, perfect for spring or autumn. Sitting at a wooden desk with a sleek laptop in front of him, he looks directly at the camera with a relaxed and friendly expression. His hands occasionally gesture as he begins to speak in a calm, engaging manner. Behind him, modern furniture like a stylish sofa, a floor lamp, and a few decorative plants add a touch of personal style, creating a warm, inviting atmosphere.",
    negative_prompt="色调艳丽，过曝，静态，细节模糊不清，字幕，风格，作品，画作，画面，静止，整体发灰，最差质量，低质量，JPEG压缩残留，丑陋的，残缺的，多余的手指，画得不好的手部，画得不好的脸部，畸形的，毁容的，形态畸形的肢体，手指融合，静止不动的画面，杂乱的背景，三条腿，背景人很多，倒着走，手指模糊",
    input_image=image,
    height=1024,
    width=688,
...
if dist.get_rank() == 0:
    save_video(video, "wan14_i2v_720p_man1_1.mp4", fps=15, quality=9)
