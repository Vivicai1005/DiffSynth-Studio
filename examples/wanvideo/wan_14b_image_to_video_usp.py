...
video = pipe(
    ...
    prompt="The young man continues live-streaming in the same cozy, minimalist living room. Maintaining a friendly and calm demeanor, he casually lifts one hand in a smooth, natural gesture while explaining something, keeping movements minimal and fluid. He leans slightly forward to engage with the audience, still seated comfortably in his casual spring/autumn attire. The background reveals personal touches like a bookshelf and framed artwork, with soft ambient lighting enhancing the relaxed, homely vibe. His eye contact with the camera remains steady and approachable, conveying an easy-going interaction.",
